<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#issueModal">New Issue</button>
...
<div class="modal fade" id="issueModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      {!! Form::open(['data-remote', 'method' => 'post', 'url' => ['admins/issue/store']]) !!}
