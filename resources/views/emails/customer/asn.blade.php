...
<html>
    <head>
        ...
        <title>Your BrushPoint.com order - {{ $payment->payment_id }}</title>
        <style type="text/css">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <table style="width:100%;border-collapse:collapse">
                                ...
                                <tr>
                                    <td style="vertical-align:top;font-size:13px;line-height:18px;font-family:Arial,sans-serif">
                                        ...
                                        <p style="margin:1px 0 8px 0;font:12px/16px Arial,sans-serif">
                                            Thank you for shopping with us. We’ll be sending you a confirmation once your item(s) have shipped. Please take a look at your order details as indicated below.
                                        </p>
                                    </td>
                                </tr>
                                <!-- <tr>
                        ...
                        <tr>
                            <td style="border-bottom:1px solid rgb(204,204,204);vertical-align:top;font-size:13px;line-height:18px;font-family:Arial,sans-serif"> <h3 style="font-size:18px;color:rgb(29, 85, 204);margin:15px 0 0 0;font-weight:normal">Shipment Details</h3> </td>
                        </tr>
                        ...
                        <tr>
                            <td style="padding-left:32px;vertical-align:top;font-size:13px;line-height:18px;font-family:Arial,sans-serif">
                                ...
                                <tr>
                                    <td colspan="2" style="font-size:10px;color:#666;padding:0 10px 20px 10px;line-height:16px;width:640px"> <p style="margin:10px 0 0 0;font:11px/16px Arial,sans-serif;color:#333"> Your package is being shipped by Canada Post. In order to provide our customers with the lowest shipping price, we cannot provide tracking numbers for our shipments.. </p> </td>
                                </tr>
                        ...
                        <br> -->
                        If you want more information or need more assistance, please don't hesitate to <a href="{{ url() }}/feedback" style="text-decoration:none;color:rgb(0,102,153);font:12px/16px Arial,sans-serif" target="_blank">
                        contact us
                        </a>.
                        </p>
                        </td>
